...
from baselines.dav_nav.ppo import AudioNavBaselinePolicy
from baselines.dav_nav.ppo.ppo import PPO
import matplotlib.pyplot as plt
from collections import defaultdict
from ss_baselines.av_wan.ppo.ppo_trainer import PPOTrainer as BasePPOTrainer

@baseline_registry.register_trainer(name="DavNavTrainer")
class PPOTrainer(BasePPOTrainer):
    ...
    def _setup_actor_critic_agent(self, ppo_cfg: Config, observation_space=None) -> None:
        ...
        self.actor_critic = AudioNavBaselinePolicy(
            ...
            use_aux_loss=ppo_cfg.aux_coef > 0.0,
        )
    ...
    def train(self) -> None:
        ...
        with TensorboardWriter(
            ...
            for update in range(start_update, self.config.NUM_UPDATES):
                ...
                delta_pth_time, value_loss, action_loss, dist_entropy, aux_loss = self._update_agent(ppo_cfg, rollouts)
                pth_time += delta_pth_time
                ...
                writer.add_scalar('Policy/Aux_Loss', aux_loss, count_steps)
    ...
    def _eval_checkpoint(
        ...
        while (
            ...
            scene_id = current_episodes[0].scene_id.split("/")[-1].split(".")[0]
            ...
            for i in range(n_envs):
                ...
                if not_done_masks[i].item() == 0:
                    ...
                    if "top_down_map" in self.config.VISUALIZATION_OPTION:
                        ...
                        plt.savefig('maps/' + scene + current_episodes[i].episode_id + '.png')
