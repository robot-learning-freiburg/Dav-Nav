...
_C.TRAINER_NAME = "DavNavTrainer"
_C.ENV_NAME = "MapNavEnv"
_C.SIMULATOR_GPU_ID = 0
_C.TORCH_GPU_ID = 0
_C.MODEL_DIR = 'data/models/dav_nav/output'
...
# -----------------------------------------------------------------------------
# Filtered_SPECTROGRAM_SENSOR
# -----------------------------------------------------------------------------
_TC.TASK.FILTERED_SPECTROGRAM_SENSOR = CN()
_TC.TASK.FILTERED_SPECTROGRAM_SENSOR.TYPE = "FilteredSpectrogramSensor"
# -----------------------------------------------------------------------------
# habitat_audio
# -----------------------------------------------------------------------------
...
_TC.SIMULATOR.AUDIO.moving_source = False
_TC.SIMULATOR.AUDIO.moving_val_test_seed = False
_TC.SIMULATOR.AUDIO.trainWithSecondAudio = False
_TC.SIMULATOR.AUDIO.trainWithSpecAugment = False
_TC.SIMULATOR.AUDIO.trainWithDistractor = False
_TC.SIMULATOR.AUDIO.time_mask_param = 32
_TC.SIMULATOR.AUDIO.val_sounds = False
_TC.SIMULATOR.AUDIO.test_sounds = False
_TC.SIMULATOR.AUDIO.val_test_dynamic = False
...
_TC.TASK.ACTION_MAP.MAP_SIZE = 3
...
# -----------------------------------------------------------------------------
# Success normalized by path length for dynamic moving target
# -----------------------------------------------------------------------------
_TC.TASK.DYNAMIC_SUCCESS_WEIGHTED_BY_PATH_LENGTH = CN()
_TC.TASK.DYNAMIC_SUCCESS_WEIGHTED_BY_PATH_LENGTH.TYPE = "DSPL"

# -----------------------------------------------------------------------------
# Dynamic Success normalized by number of action metric
# -----------------------------------------------------------------------------
_TC.TASK.DYNAMIC_SUCCESS_WEIGHTED_BY_NUM_ACTION = CN()
_TC.TASK.DYNAMIC_SUCCESS_WEIGHTED_BY_NUM_ACTION.TYPE = "DSNA"
